...
-- Note: Ensure customer_id exists in both tables for the join to work correctly.
--       INNER JOIN can be simplified to JOIN.
-- ------------------------------------------------------------------------------------
USE sql_store;
...
-- Note: Verify that the product_id matches between order_items and products to avoid missing data.
-- ------------------------------------------------------------------------------------
USE sql_store;
